...
TEST_F(SettingsManagerTest, Instantiate_nothrow) {
  EXPECT_NO_THROW(Stroalgo::Configuration::SettingsManager::GetInstance());
}

TEST_F(SettingsManagerTest, SingletonInstance_sameInstance) {
  Stroalgo::Configuration::Settings &lInstance1 =
      Stroalgo::Configuration::SettingsManager::GetInstance();
  Stroalgo::Configuration::Settings &lInstance2 =
      Stroalgo::Configuration::SettingsManager::GetInstance();
...
TEST_F(SettingsManagerTest, GetSettingsFilePath) {
  EXPECT_EQ(Stroalgo::Configuration::SettingsManager::GetInstance()
                .GetSettingsFilePath(),
            "settings.ini");
}

TEST_F(SettingsManagerTest, LoadSettings_noFileExists) {
  EXPECT_FALSE(Stroalgo::Configuration::SettingsManager::GetInstance()
                   .AreSettingsLoaded());

  Stroalgo::Configuration::SettingsManager::GetInstance().LoadSettings();

  EXPECT_TRUE(Stroalgo::Configuration::SettingsManager::GetInstance()
                  .AreSettingsLoaded());
...
TEST_F(SettingsManagerTest, LoadSettings_FileExists_NewModule_NameEmpty) {
  ...
  EXPECT_THROW(Stroalgo::Configuration::SettingsManager::GetInstance()
