...
class MyClassSingletonWrap : public Utilities::Common::GenericSingleton<MyClass> 
{
    friend class Utilities::Common::GenericSingleton<MyClass>; // Allow Singleton access to MyClass constructor
    private:
