...
if(CMAKE_BUILD_TYPE STREQUAL "Release")
  add_compile_options(
    ...
    /Oi # Replaces some function calls with intrinsic that help your application
        # run faster.
    /fp:fast # option allows the compiler to reorder, combine, or simplify
             # floating-point operations to optimize floating-point code for
             # speed and space.
    /Qfast_transcendentals # option forces transcendental functions to be
                           # converted to inline code to improve execution speed
  )
...
elseif(CMAKE_BUILD_TYPE STREQUAL "Debug")
  add_compile_options(
    /fp:strict # the compiler generates code that allows the program to safely
               # unmask floating-point exceptions, read or write floating-point
               # status registers, or change rounding modes
    /GR # Adds code to check object types at run time.
    /guard:cf # option causes the compiler to analyze control flow for indirect
              # call targets at compile time
    /Zi # Generates complete debugging information.
    /analyze # Turns on code analysis.
    /diagnostics:column # option also includes the column where the issue was
                        # found
...
# options--------------------------------------------------------
add_compile_options(
  # /await #Option enables compiler support for C++ coroutines /W4 #Displays
  # level 1, level 2, and level 3 warnings, and all level 4 (informational)
  # warnings that aren't off by default.
  ...
  /GT # Supports fiber safety for data allocated using static thread-local
      # storage
  /Gu # Ensure distinct functions have distinct addresses.
  /Gw # Option causes the compiler to package global data in individual COMDAT
      # sections
  ...
  /Zc:enumTypes # option implements Standard C++ conforming behavior for
                # deduction of enumeration base types
  ...
  /D_WIN32_WINNT=0x0A00 # It defines the version of the windows header files to
                        # use(In this case Win10)
  /fsanitize-address-use-after-return # a compiler instrumentation of used after
                                      # return
)
